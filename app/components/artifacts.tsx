...
import { Modal, showToast, IconButton, Loading } from "./ui-lib";
import { copyToClipboard, downloadAs } from "../utils";
import { Path, ServerAPIPath } from "@/app/constant";
import styles from "./artifacts.module.scss";
import { CopyOutlined, DownloadOutlined, ShareAltOutlined, SyncOutlined } from "@ant-design/icons";
  ...
  return (
    <>
      <div className="window-action-button" style={style}>
        <IconButton
          icon={loading ? <LoadingButtonIcon /> : <ShareAltOutlined />}
          bordered
...
export function Artifacts() {
  ...
  useEffect(() => {
    if (id) {
      fetch(`${ServerAPIPath.Artifacts}?id=${id}`)
        .then((res) => {
          if (res.status > 300) {
  ...
  return (
    <div className={styles["artifacts"]}>
      <div className={styles["artifacts-header"]}>
        ...
        />
        <div className={styles["artifacts-title"]}>AITaaS Artifacts</div>
