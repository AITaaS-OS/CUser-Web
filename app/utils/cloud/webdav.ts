  ...
  return {
    async check() {
      try {
        ...
        sys.log.error("[WebDav] failed to check", e);
      }
    ...
    async get(key: string) {
      ...
      sys.log.info("[WebDav] get key = ", key, res.status, res.statusText);
    ...
    async set(key: string, value: string) {
      ...
      sys.log.info("[WebDav] set key = ", key, res.status, res.statusText);
    },
