...
const LocalStateSetters = {
  ...
  [StoreKey.Model]: useModelProviderConfig.setState,
...
const LocalStateGetters = {
  ...
  [StoreKey.Model]: () => getNonFunctionFileds(useModelProviderConfig.getState()),
...
const MergeStates: StateMerger = {
  ...
  [StoreKey.Model]: mergeWithUpdate<AppState[StoreKey.Model]>,
};
