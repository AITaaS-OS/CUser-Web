...
import { ChatMessage, Updater } from "../../types";
import { CheckBox, IconButton, Input } from "../../components/ui-lib";
...
export function MessageSelector(props: {
  ...
  const isValid = (m: ChatMessage) => m.content && !m.isError && !m.isStreaming;
          ...
          return (
            ...
            >
              <div className={styles["avatar"]}>
                {m.role === "user" ? (
                  <Avatar avatar={user.userAvatar}></Avatar>
                ) : (
